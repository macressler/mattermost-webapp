...
export default function HelpFormatting() {
    ...
    message.push('`' + localizeMessage('help.formatting.linkEx', '[Check out uChat!](https://about.mattermost.com/)') + '`');
    message.push(localizeMessage('help.formatting.renders', 'Renders as:') + ' ' + localizeMessage('help.formatting.linkEx', '[Check out uChat!](https://about.mattermost.com/)'));
